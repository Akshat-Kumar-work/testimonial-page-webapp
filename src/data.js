const reviews = [
  ...
  },
  {
    ...
    image: <img className="w-[140px] h-[140px] z-[25] aspect-square  rounded-full"
    src={require('./images/himanshi.jpg')}></img>,
    text: "I have been working with this team for several years now, and I have always been impressed with their creativity and attention to detail. They are true professionals who take pride in their work and always go above and beyond to deliver exceptional results.",
  },
  {
    id: 3,
    name: "Owais Ali",
    ...
    image: <img className="w-[140px] h-[140px] z-[25] aspect-square  rounded-full"
     src={require('./images/owais.jpeg')}></img>,
  ...
  {
    id: 4,
    name: "Ritik Hutnarayan",
    job: "Marketing Manager",
    image: <img className="w-[140px] h-[140px] z-[25] aspect-square  rounded-full"
     src={require('./images/ritik.jpeg')}></img>,
  ...
  },
  {
    ...
    job: "Data Scientist",
    image: <img className="w-[140px] h-[140px] z-[25] aspect-square  rounded-full"
     src={require('./images/aditya.jpg')}></img>,
